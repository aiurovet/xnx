  ...
  Helper.forEachMemoryFileSystem((fileSystem) {
    group('Directory', () {
      ...
      test('entityListSync', () {
        ...
        Path.fileSystem
            .directory(Path.join(dir.path, 'sub-sub-dir'))
            .createSync();
        ...
        Path.fileSystem
            .file(Path.join(dir.path, 'sub-sub-dir', 'a.csv'))
            .createSync();

        expect(
            dir
                .entityListSync('',
                    checkExists: true, takeDirs: true, takeFiles: false)
                .length,
            1);
        expect(
            dir
                .entityListSync('',
                    checkExists: true, takeDirs: false, takeFiles: true)
                .length,
            4);
        expect(
            dir
                .entityListSync('',
                    checkExists: true, takeDirs: true, takeFiles: true)
                .length,
            5);
        expect(
            dir
